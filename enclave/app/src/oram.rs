...
/**
* this code is taken from mobilecoin at
* https://github.com/njeans/sgxoram/tree/sgx_sdk_compat/mobilecoin/fog/ocall_oram_storage/untrusted
**/
...
impl UntrustedAllocation {
    ...
    pub fn new(count: usize, data_item_size: usize, meta_item_size: usize) -> Self {
        ...
        println!("Untrusted is allocating oram storage: count = {}, data_size = {}, meta_size = {}, mem = {} KB. Total mem allocated this way = {} KB", count, data_item_size, meta_item_size, mem_kb, total_mem_kb);
        assert!(
            data_item_size % 8 == 0,
